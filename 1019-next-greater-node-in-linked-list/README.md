<h2><a href="https://leetcode.com/problems/next-greater-node-in-linked-list/description/">1072. Next Greater Node In Linked List</a></h2><h3>Medium</h3><hr><p>You are given the <code>head</code> of a linked list with <code>n</code> nodes.</p>
